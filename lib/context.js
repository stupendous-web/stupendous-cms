...
export const Provider = ({ children }) => {
  ...
  useEffect(() => {
    ...
    axios.get("/api/models").then((response) => setModels(response?.data));
    axios
      .get("/api/properties")
      .then((response) => setProperties(response?.data));
    axios.get("/api/objects").then((response) => setObjects(response?.data));
    axios.get("/api/users").then((response) => setUsers(response?.data));
    axios.get("/api/files").then((response) => setFiles(response?.data));
  }, []);
